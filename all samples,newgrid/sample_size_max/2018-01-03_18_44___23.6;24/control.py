...
abs_threshold = 40 # no of min detections to detect object

substart = 23.6 ; subend = 24 # single black car, low abs_threshold needed!
...
sample_size = 8179 # for making the carlist for training and validation
